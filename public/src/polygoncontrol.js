  ...
  */
  ...
  me.Options = {
    ...
    tooltip:{
      ...
      cursor_off:"",
      titles:{
         start:"Click to start drawing your region",
         middle:"Click to continue drawing your region",
         end:"Click a vertex once, or double click on the map to end this region"
      },
      callback:null      
    },
    newGeometryOptions: { 
